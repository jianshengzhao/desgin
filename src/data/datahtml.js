var datahtml = {
  ...
  text: {
    ...
    html: '<div class="text module"  datatext="文字"><div class="promptBox">修改文字</div><a target="_blank">请输入文字</a></div>'
  },
  editor: {
  ...
  picture: {
    ...
    html: '<div class="picture module"  datatext="图片"><div class="promptBox">修改图片</div><a class="picBox" target="_blank"><img src="http://static.ebanhui.com/ebh/tpl/default/images/folderimgs/course_cover_default_243_144.jpg"></a></div>'
  },
  button: {
  ...
  navigation: {
    ...
    html: '<div class="navigation module" datatext="导航栏"><div class="promptBox">导航栏设置</div><div class="navaBox"><a href="/index.html">主页</a><a href="/introduce.html">网校简介</a><a href="/dyinformation.html">新闻资讯</a><a href="/contacts.html">联系我们</a><a href="/navcm/1.html">全校新闻</a><a href="/publish.html">网校发布</a><a href="/shop.html">在线商城</a></div><div class="login_box wrap_login"><a class="reg reginpage" id="nav-reginpage" href="javascript:;">注册</a><a class="log" id="nav-login" href="javascript:;">登录</a></div><div class="search_box"><input name="txtname" class="inp_search" id="search" placeholder="搜索关键字" type="text"><input class="btn-search" value="" type="button"></div></div>'
  },
  audition: {
